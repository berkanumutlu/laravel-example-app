        ...
        <div class="max-w-7xl mx-auto p-6 lg:p-8">
            <div class="flex justify-center">
                <svg viewBox="0 0 62 65" fill="none" xmlns="http://www.w3.org/2000/svg"
                     class="h-16 w-auto bg-gray-100 dark:bg-gray-900 mr-3">
                    <path
                    ...
                    <div
                        ...
                        <div>
                            ...
                            <p class="mt-4 text-gray-500 dark:text-gray-400 text-sm leading-relaxed">
                                ...
                                <a href="https://nova.laravel.com" target="_blank"
                                ...
                                and
                                <a href="https://envoyer.io" target="_blank"
                                ...
                                libraries like
                                <a href="https://laravel.com/docs/billing" target="_blank"
                                ...
                                <a href="https://laravel.com/docs/horizon" target="_blank"
                                ...
                                <a href="https://laravel.com/docs/telescope" target="_blank"
            ...
            <div class="flex justify-center mt-16 px-0 sm:items-center sm:justify-between">
                <div class="text-center text-sm text-gray-500 dark:text-gray-400 sm:text-left">
                    <div class="flex items-center gap-4">
                        <a href="https://github.com/berkanumutlu" target="_blank"
                           class="group inline-flex items-center hover:text-gray-700 dark:hover:text-white">
                            <svg height="32" aria-hidden="true" viewBox="0 0 16 16" version="1.1" width="32"
                                 data-view-component="true"
                                 class="octicon octicon-mark-github v-align-middle color-fg-default mr-1">
                                <path
