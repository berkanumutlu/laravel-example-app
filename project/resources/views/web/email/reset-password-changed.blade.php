                                            ...
                                            <td class="pad" style="width:100%;padding-right:0px;padding-left:0px;">
                                                <div align="center" class="alignment" style="line-height:10px">
                                                    <div style="max-width: 147.333px;">
                                                        <img alt="Laravel Example App Logo"
                                                             src="{{ asset($site_logo) }}"
                                                             style="display: block; height: auto; border: 0; width: 100%;"
                                                             title="Laravel Example App Logo"
                                                             width="147.333"/>
                                                    </div>
                                                </div>
                                            </td>
                                            ...
                                            <td class="pad" style="width:100%;">
                                                <div align="center" class="alignment" style="line-height:10px">
                                                    <div style="max-width: 680px;">
                                                        <img alt="Top round corners"
                                                             src="{{ asset('assets/email/reset-password/images/round_corner_top.png') }}"
                                                             style="display: block; height: auto; border: 0; width: 100%;"
                                                ...
                                                <div align="center" class="alignment" style="line-height:10px">
                                                    <div class="fullWidth" style="max-width: 374px;">
                                                        <img
                                                            ...
                                                            src="{{ asset('assets/email/reset-password/images/password_reset.png') }}"
                                                            style="display: block; height: auto; border: 0; width: 100%;"
                                    ...
                                    <table border="0" cellpadding="0" cellspacing="0" class="heading_block block-3"
                                        ...
                                        <tr>
                                            <td class="pad" style="text-align:center;width:100%;">
                                                <h1 style="margin: 0; color: #101010; direction: ltr; font-family: Arial, Helvetica Neue, Helvetica, sans-serif; font-size: 27px; font-weight: normal; letter-spacing: normal; line-height: 120%; text-align: center; margin-top: 0; margin-bottom: 0; mso-line-height-alt: 32.4px;">
                                                    <strong>Changed Your Password?</strong></h1>
                                            </td>
                                        </tr>
                                    </table>
                                </td>
                                            ...
                                            <td class="pad"
                                                ...
                                                <div
                                                    ...
                                                    <p style="margin: 0; word-break: break-word;">
                                                        <span>We wanted to let you know that your password has changed. If you did not perform this action, please contact support our contacts.</span>
                                                    </p>
                                                </div>
                                            </td>
                                        </tr>
                                            ...
                                            <td class="pad">
                                                <div align="center" class="alignment"><!--[if mso]>
                                                    <v:roundrect xmlns:v="urn:schemas-microsoft-com:vml"
                                                                 ...
                                                                 href="#"
                                                                 {{--href="{{ route('contact') }}"--}}
                                                    style="height:47px;width:162px;v-text-anchor:middle;"
...
<![endif]--><a
                                                        ...
                                                        target="_blank"><span
                                                            style="padding-left:20px;padding-right:20px;font-size:16px;display:inline-block;letter-spacing:normal;"><span
                                                                style="word-break: break-word; line-height: 32px;">Contact Us</span></span></a>
                                            ...
                                            <td class="pad" style="width:100%;">
                                                <div align="center" class="alignment" style="line-height:10px">
                                                    <div style="max-width: 679px;">
                                                        <img alt="Bottom round corners"
                                                             src="{{ asset('assets/email/reset-password/images/round_corner_bottom.png') }}"
                                                             style="display: block; height: auto; border: 0; width: 100%;"
                        ...
                        <table align="center" border="0" cellpadding="0" cellspacing="0" class="row-content stack"
                            ...
                            <tr>
                                <td class="column column-1"
                                                            ...
                                                            <td style="padding:0 2px 0 2px;">
                                                                <a href="https://www.facebook.com" target="_blank">
                                                                    <img
                                                                        ...
                                                                        src="{{ asset('assets/email/reset-password/images/facebook2x.png') }}"
                                                            ...
                                                            <td style="padding:0 2px 0 2px;">
                                                                <a
                                                                    ...
                                                                    <img
                                                                        ...
                                                                        src="{{ asset('assets/email/reset-password/images/twitter2x.png') }}"
                                                                        style="display: block; height: auto; border: 0;"
                                                            ...
                                                            <td style="padding:0 2px 0 2px;">
                                                                <a href="https://www.linkedin.com" target="_blank">
                                                                    <img
                                                                        ...
                                                                        src="{{ asset('assets/email/reset-password/images/linkedin2x.png') }}"
                                                                        style="display: block; height: auto; border: 0;"
                                                            ...
                                                            <td style="padding:0 2px 0 2px;">
                                                                <a href="https://www.instagram.com" target="_blank">
                                                                    <img alt="Instagram" height="32"
                                                                         src="{{ asset('assets/email/reset-password/images/instagram2x.png') }}"
                                                                         style="display: block; height: auto; border: 0;"
                                    ...
                                    <table border="0" cellpadding="0" cellspacing="0" class="menu_block block-3"
                                           role="presentation" style="mso-table-lspace: 0pt; mso-table-rspace: 0pt;"
                                           width="100%">
                                        <tr>
                                            <td class="pad"
                                                    ...
                                                    <tr>
                                                        <td class="alignment" style="text-align:center;font-size:0px;">
                                                            ...
                                                            <div class="menu-trigger"
                                                                ...
                                                                <label class="menu-label" for="memu-r7c0m2"
                                                            ...
                                                            <div class="menu-links"><!--[if mso]>
                                                                ...
                                                                <!--[if mso]></td><![endif]--><!--[if mso]></tr></table>
                                                                <![endif]--></div>
                                                        </td>
                                                    </tr>
                                                </table>
                                                                        ...
                                                                        <a href="http://designedwithbeefree.com/"
                                                                           ...
                                                                           target="_blank">
                                                                            <img align="center"
                                                                                 ...
                                                                                 src="{{ asset('assets/email/reset-password/images/Beefree-logo.png') }}"
