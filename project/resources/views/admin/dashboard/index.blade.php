...
@section("content")
            ...
            <div class="card widget widget-list">
                <div class="card-header">
                    <h5 class="card-title">Todo<span
                            class="badge badge-success badge-style-light">14 completed</span>
                    </h5>
                </div>
                <div class="card-body">
                    <span class="text-muted m-b-xs d-block">showing 5 out of 23 active tasks.</span>
                    ...
                    <div class="widget-payment-request-container">
                        ...
                        <div class="widget-payment-request-product">
                            <div class="widget-payment-request-product-image m-r-sm">
                                <img src="{{ asset('assets/admin/images/other/facebook_logo.png') }}"
                                     class="mt-auto"
                                     alt="">
                            </div>
                ...
                <div class="card-body">
                    <div class="widget-popular-product-container">
                        <div class="widget-popular-product-image">
                            <img src="{{ asset('assets/admin/images/widgets/popular-product.jpeg') }}"
                                 alt="">
                        </div>
    ...
    <div class="row">
        <div class="col-xl-4">
            <div class="card">
                <img src="{{ asset('assets/admin/images/widgets/blog5.jpeg') }}" class="card-img-top"
                     alt="...">
                <div class="card-body">
                ...
                <div class="card-body">
                    <div class="widget-info-container">
                        <div class="widget-info-image"
                             style="background: url('{{ asset('assets/admin/images/widgets/security.svg') }}')"></div>
