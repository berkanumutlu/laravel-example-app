...
<body>
    <nav class="navbar navbar-expand-md navbar-dark sticky-top bg-dark p-0">
        <a href="{{ route('admin.log-viewer::dashboard') }}" class="navbar-brand mr-0">
        ...
        <div class="collapse navbar-collapse" id="navbarNav">
            <ul class="navbar-nav mr-auto">
                <li class="nav-item {{ Route::is('admin.log-viewer::dashboard') ? 'active' : '' }}">
                    <a href="{{ route('admin.log-viewer::dashboard') }}" class="nav-link">
                        <i class="fa fa-dashboard"></i> @lang('Dashboard')
                    </a>
                </li>
                <li class="nav-item {{ Route::is('admin.log-viewer::logs.list') ? 'active' : '' }}">
                    <a href="{{ route('admin.log-viewer::logs.list') }}" class="nav-link">
