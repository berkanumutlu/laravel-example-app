            ...
            <div class="card mb-4">
                <div class="card-header">
                    ...
                    <div class="group-btns pull-right">
                        <a href="{{ route('admin.log-viewer::logs.download', [$log->date]) }}" class="btn btn-sm btn-success">
                ...
                <div class="card-footer">
                    {{-- Search --}}
                    <form action="{{ route('admin.log-viewer::logs.search', [$log->date, $level]) }}" method="GET">
                        <div class="form-group">
                            <div class="input-group">
                                <input id="query" name="query" class="form-control" value="{{ $query }}" placeholder="@lang('Type here to search')">
                                <div class="input-group-append">
                                    @unless (is_null($query))
                                        <a href="{{ route('admin.log-viewer::logs.show', [$log->date]) }}" class="btn btn-secondary">
